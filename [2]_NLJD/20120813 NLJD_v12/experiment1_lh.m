%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% This is first experiment. In this experiment conducting the detection 
%%% with the database which are generated totally by random . The purpose is
%%% to figure whether the asymetric case also existes in MLP or not,which
%%% means the Advenced D/B should be better performance than the
%%% convetional D/B, whatever the condition is under ideal situation or
%%% interfference situation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for idx_k = 1:length(k)
    for idx_frame = 1:frame
        ...
        for idx_simulation = 1:knn_simulation_no
            ...
            fuzzy_Class = kNN_NLJD(k(idx_k),Measured,fuzzy_cluster1,fuzzy_cluster2);
            ...
            Err_kNN_Fuzzy(idx_simulation)dui = xor(fuzzy_Class,kNN_Class);
