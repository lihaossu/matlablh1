...
%                                                     plot(NLJ(idx_Class1,1),NLJ(idx_Class1,2),'rs','LineWidth',2,'MarkerSize',10);
%                                                     hold on;
%                                                 end;
%             
%                                                 % Class2 Plot
%                                                 for idx_Class2 = 1:size(Metal,1)
%                                                     plot(Metal(idx_Class2,1),Metal(idx_Class2,2),'bo','LineWidth',2,'MarkerSize',10);
%                                                     hold on;
%                                                 end;
%                                                 
%                                         plot(Measured(1),Measured(2),'g*','LineWidth',2,'MarkerSize',10);
%             
...
% %             
            ...
            % Fuzzy DL
%             Fuzzy_Estimation = kNN(k(length(k)),Measured_Noise,fuzzy_cluster1,fuzzy_cluster2);
            
            % kNN
            kNN_Estimation = kNN(k(idx_k),Measured_Noise,Class1(:,1:2),Class2(:,1:2));
            
            Err(idx_simulation) = xor(Symmetric_Estimation,kNN_Estimation);
