...
for idx_Class1 = 1:size(Class1,1)
    plot(Class1(idx_Class1,1),Class1(idx_Class1,2),'rs','LineWidth',2,'MarkerSize',9);
    hold on;
end;

% Class2 Plot
for idx_Class2 = 1:size(Class2,1)
    plot(Class2(idx_Class2,1),Class2(idx_Class2,2),'bo','LineWidth',2,'MarkerSize',9);
    hold on;
end;
...
for idx_neighborsInd = 1:size(neighborsInd)
    plot(Samples(neighborsInd,1),Samples(neighborsInd,2), ...
        'co','LineWidth',2,'MarkerSize',12);
    hold on;
end;

% Measured Data Plot
plot(Measured(1),Measured(2),'go','LineWidth',2,'MarkerSize',9);
grid on;
axis([0 10 0 10]);
