...
Second  = [Second_1; ceil(Mean_Value+Deviation_Value*randn(length(Second_1),1)+Second_1)];
Third = [Third_1; ceil(Mean_Value+Deviation_Value*randn(length(Second_1),1)+Third_1)];
...
save Training_50.mat Class1 Class2
