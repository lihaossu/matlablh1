...
%             Measured = 1000.*rand(1,2);
            Measured_Origin = ceil(C+sqrt(Measure_Variance)*randn(1,2));
            Measured = Measured_Origin + ceil(sqrt(Noise_Variance)*randn(1,2));
...
plot_data_Asymmetric_40 = [Prob_Fairness_Symmetric' Prob_kNN_Class_Symmetric' ...
    Prob_fuzzy_Class_Symmetric' Prob_kNN_Class_Fairness'...
    Prob_fuzzy_Class_Fairness'];

bar(k,plot_data_Asymmetric_40);
legend('Fairness','DL kNN','DL kNN /w Fuzzy','Advanced kNN','Advanced kNN /w Fuzzy');
