...
<li>Within MATLAB:
	<ul>
	<li>Type "mltDoc" to see
		<ul>
		<li>Tutorial for getting started
		<li>User guide
		<li>Application notes
		<li>Function reference
		</ul>
	Or type "doc" and navigate to the home page. At the bottom right of the home page, under Supplemental Software, click the link to "Machine Learning Toolbox". (You need to add the toolbox to the search path first.)
...
-->
<li>On-line tutorials using the toolbox, with many application examples:
	<ul>
	<li><a target=_blank href="/jang/books/dcpr">Data Clustering and Pattern Recognition</a>
		<ul>
		<li><a target=_blank href="/jang/books/dcpr/appNoteLeafRecognition.asp?title=13-1 Leaf Recognition">Leaf Recognition</a></td><tr>
		<li><a target=_blank href="/jang/books/dcpr/appNoteHumanId.asp?title=13-2 Human Identification">Human Identification</a></td><tr>
		<li><a target=_blank href="/jang/books/dcpr/appNoteFingerReady.asp?title=13-3 Finger-Ready Detection">Finger-Ready Detection</a></td><tr>
		<li><a target=_blank href="/jang/books/dcpr/appNoteEmoticonMood.asp?title=13-4 Emoticon Mood Recognition">Emoticon Mood Recognition</a></td>
		</ul>
	<li><a target=_blank href="/jang/books/audioSignalProcessing">Audio Signal Processing and Recognition</a>
		<ul>
		<li><a target=_blank href="/jang/books/audioSignalProcessing/appNoteCoinType.asp?title=21-1 Coin Type Recognition">Coin Type Recognition</a></td><tr>
		<li><a target=_blank href="/jang/books/audioSignalProcessing/appNoteSingingType.asp?title=21-2 Singing Type Classification">Singing Type Classification</a></td><tr>
		<li><a target=_blank href="/jang/books/audioSignalProcessing/appNoteTone.asp?title=21-3 Tone recognition">Tone recognition</a></td><tr>
		<li><a target=_blank href="/jang/books/audioSignalProcessing/appNoteMgc.asp?title=21-4 Music genre classification">Music genre classification</a></td><tr>
		<li><a target=_blank href="/jang/books/audioSignalProcessing/appNoteStress.asp?title=21-5 Lexical stress detection">Lexical stress detection</a></td>
		</ul>
	</ul>
</ul>
