% This experiment purpose to detect multi objects by RBF algorithm
...
Metal_x1_ini = 300; Metal_y1_ini = 200; Metal_x2_ini = 900; Metal_y2_ini = 800;
...
Electronic_x1_ini = 500; Electronic_y1_ini = 600; Electronic_x2_ini = 1300;Electronic_y2_ini =1400;
...
Metal_x1_ini = Metal_x1_ini+Training_Standard_Deviation*randn(1,num_hd/4);
Metal_y1_ini = Metal_y1_ini+Training_Standard_Deviation*randn(1,num_hd/4);
Metal_x2_ini = Metal_x2_ini+Training_Standard_Deviation*randn(1,num_hd/4);
Metal_y2_ini = Metal_y2_ini+Training_Standard_Deviation*randn(1,num_hd/4);
label0 = 1*ones(1,length(Metal_x1_ini));
Electronic_x1_ini = Electronic_x1_ini+Training_Standard_Deviation*randn(1,num_hd/4);
Electronic_y1_ini = Electronic_y1_ini+Training_Standard_Deviation*randn(1,num_hd/4);
Electronic_x2_ini = Electronic_x2_ini+Training_Standard_Deviation*randn(1,num_hd/4);
Electronic_y2_ini = Electronic_y2_ini+Training_Standard_Deviation*randn(1,num_hd/4);
label1 = -1*ones(1,length(Electronic_x1_ini));
data_ini1 = [Metal_x1_ini;Metal_y1_ini;label0];
data_ini2 = [Metal_x2_ini;Metal_y2_ini;label0];
data_ini3 = [Electronic_x1_ini;Electronic_y1_ini;label1];
data_ini4 = [Electronic_x2_ini;Electronic_y2_ini;label1];
data_ini(:,1:5) = data_ini1(:,1:5);
data_ini(:,6:10) = data_ini2(:,1:5);
data_ini(:,11:15) = data_ini3(:,1:5);
data_ini(:,16:20) = data_ini4(:,1:5);
    [n_row_ini, n_col_ini] = size(data_ini);
shuffle_seq_ini = randperm(n_col_ini);
for i = (1:n_col_ini),
    data_shuffled_ini(:,i) = data_ini(:,shuffle_seq_ini(i));
end;
...
plot(c(1,:),c(2,:),'yd','Linewidth',2,'MarkerSize',5);
% %% Adding Measured
% plot(Measured(1,1),'rd');
