...
Metal_x_ini = 400; Metal_y_ini = 100;
...
Electronic_x_ini = 200; Electronic_y_ini = 900;
...
% Metal = [ceil(Metal_x+Training_Standard_Deviation*randn(num_tr,1)) ceil(Metal_y+Training_Standard_Deviation*randn(num_tr,1))];
% NLJ = [ceil(Electronic_x+Training_Standard_Deviation*randn(num_tr,1)) ceil(Electronic_y+Training_Standard_Deviation*randn(num_tr,1))];
...
Metal_x_ini = Metal_x_ini+Training_Standard_Deviation*randn(1,num_hd/2);
Metal_y_ini = Metal_y_ini+Training_Standard_Deviation*randn(1,num_hd/2);
label0 = 1*ones(1,length(Metal_x_ini));
Electronic_x_ini = Electronic_x_ini+Training_Standard_Deviation*randn(1,num_hd/2);
Electronic_y_ini = Electronic_y_ini+Training_Standard_Deviation*randn(1,num_hd/2);
label1 = -1*ones(1,length(Electronic_x_ini));
data_ini = [Metal_x_ini,Electronic_x_ini; 
        Metal_y_ini,Electronic_y_ini;
        label0,label1];
...
plot(Measured(1,1),Measured(1,2),'gd','Linewidth',2,'MarkerSize',5);
% %% Adding Measured
