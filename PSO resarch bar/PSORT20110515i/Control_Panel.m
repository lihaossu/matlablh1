...
OnOff_Cauchy_mutation_of_global_best = false; %as used in
...
if OnOff_graphs %When this switch is inactive, the switches below will not clutter the workspace.
    ...
    OnOff_graph_fg = logical(1); %Graph objective function's value for each iteration number's global best
    ...
    Figure_Position = [215 133 1289 792];
